...
class PostControllerTest {
    ...
    @Test
    void whenCalled_thenReturn200AndOnlyUserPostList() throws Exception {
    ...
    @Test
    void whenCreatePostRequestIsValid_thenReturn201AndCreatedPost() throws Exception {
    ...
    @Test
    void whenCreatePostRequestIsInvalid_thenReturn400AndErrors() throws Exception {
        User user = new UserBuilder("user1@example.com").build();
        entityManager.persist(user);
